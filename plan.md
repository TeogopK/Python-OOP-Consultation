...
Topics to raise:
- Create a Data analytics drive for every course and every year, similar to this one - [FMI SE drive](https://drive.google.com/drive/folders/1IVegM_lu6pyHuoiNtafw2tkV-UaaGlla).
...
- A recommended task from the Python course with test cases and many solutions to compare with - [link](https://py-fmi.org/homework/5).